                                        ...
                                        <div class="add-group">
                                            <a href="#" data-bs-toggle="modal"
                                               ...
                                               class=" modal-effect btn btn-primary add-pluss ms-2"><img
                                                    src="{{asset('dashboard/assets/img/icons/plus.svg')}}" alt=""> Add languages</a>
                                        ...
                                        <div class="dropdown dropdown-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <a class="dropdown-item" href="#" data-bs-toggle="modal"
                                                   data-bs-target="#edit_language" data-language_id="{{$info->id}}"
                                                   data-name="{{$info->name}}" data-slug="{{$info->slug}}"
                                                ><i
                                                        class="fa-solid fa-pen-to-square m-r-5"></i> Edit</a>

                                                <a class="dropdown-item" data-language_id="{{$info->id}}" href="#"
                                                   data-bs-toggle="modal" data-bs-target="#delete_language"><i
...
<div class="modal custom-modal fade invoices-preview" id="edit_language" role="dialog">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="edit_product">Edit language</h5>
                        ...
                        <div class="col-lg-12">
                            <div class="card invoice-info-card">
                                <div class="card-body pb-0">
                                    <div class="modal-body">
                                        <form action="{{route('languages.update','edit')}}" method="post"
    ...
    {{--    delete_service--}}
    <div class="modal custom-modal modal-bg fade" id="delete_language" role="dialog">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="modal-btn delete-action">
                        <div class="row">
                            <div class="col-6">
                                <form action="{{route('languages.destroy','delete')}}" method="post">
                                    @csrf
                                    @method('DELETE')
                                    <input type="hidden" id="language_id" value="" name="language_id">
...
<script src="{{asset('dashboard/assets/js/app.js')}}"></script>
    ...
    <script>
        // Model Delete
        $('#delete_language').on('show.bs.modal', function (event) {
    ...
    <script>
        // Model Edit
        $('#edit_language').on('show.bs.modal', function (event) {
            var button = $(event.relatedTarget)
            var id = button.data('language_id')
