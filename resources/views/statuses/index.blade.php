                                        ...
                                        <div class="add-group">
                                            <a href="#" data-bs-toggle="modal"
                                               ...
                                               class=" modal-effect btn btn-primary add-pluss ms-2"><img
                                                    src="{{asset('dashboard/assets/img/icons/plus.svg')}}" alt=""> Add statuses</a>
                                        ...
                                        <div class="dropdown dropdown-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <a class="dropdown-item" href="#" data-bs-toggle="modal"
                                                   data-bs-target="#edit_status" data-status_id="{{$info->id}}"
                                                   data-name="{{$info->name}}" 
                                                ><i
                                                        class="fa-solid fa-pen-to-square m-r-5"></i> Edit</a>

                                                <a class="dropdown-item" data-status_id="{{$info->id}}" href="#"
                                                   data-bs-toggle="modal" data-bs-target="#delete_status"><i
...
<div class="modal custom-modal fade invoices-preview" id="edit_status" role="dialog">
                        ...
                        <div class="col-lg-12">
                            <div class="card invoice-info-card">
                                <div class="card-body pb-0">
                                    <div class="modal-body">
                                        <form action="{{route('statuses.update','edit')}}" method="post"
    ...
    {{--    delete_service--}}
    <div class="modal custom-modal modal-bg fade" id="delete_status" role="dialog">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="modal-btn delete-action">
                        <div class="row">
                            <div class="col-6">
                                <form action="{{route('statuses.destroy','delete')}}" method="post">
                                    @csrf
                                    @method('DELETE')
                                    <input type="hidden" id="status_id" value="" name="status_id">
