                                        ...
                                        <div class="add-group">
                                            <a href="#" data-bs-toggle="modal"
                                               ...
                                               class=" modal-effect btn btn-primary add-pluss ms-2"><img
                                                    src="{{asset('dashboard/assets/img/icons/plus.svg')}}" alt=""> Add Writers</a>
                                        ...
                                        <div class="dropdown dropdown-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <a class="dropdown-item" href="#" data-bs-toggle="modal"
                                                   data-bs-target="#edit_writer" data-writer_id="{{$info->id}}"
                                                   data-name="{{$info->name}}" data-slug="{{$info->slug}}"
                                                ><i
                                                        class="fa-solid fa-pen-to-square m-r-5"></i> Edit</a>

                                                <a class="dropdown-item" data-writer_id="{{$info->id}}" href="#"
                                                   data-bs-toggle="modal" data-bs-target="#delete_writer"><i
...
<div class="modal custom-modal fade invoices-preview" id="edit_writer" role="dialog">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="edit_product">Edit writer</h5>
                        ...
                        <div class="col-lg-12">
                            <div class="card invoice-info-card">
                                <div class="card-body pb-0">
                                    <div class="modal-body">
                                        <form action="{{route('writers.update','edit')}}" method="post"
    ...
    {{--    delete_service--}}
    <div class="modal custom-modal modal-bg fade" id="delete_writer" role="dialog">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="modal-btn delete-action">
                        <div class="row">
                            <div class="col-6">
                                <form action="{{route('writers.destroy','delete')}}" method="post">
                                    @csrf
                                    @method('DELETE')
                                    <input type="hidden" id="writer_id" value="" name="writer_id">
...
<script src="{{asset('dashboard/assets/js/app.js')}}"></script>
    ...
    <script>
        // Model Delete
        $('#delete_writer').on('show.bs.modal', function (event) {
            var button = $(event.relatedTarget)
            var writer_id = button.data('writer_id')
            var modal = $(this)
            modal.find('.modal-body #writer_id').val(writer_id);
        })
    </script>

    <script>
        // Model Edit
        $('#edit_writer').on('show.bs.modal', function (event) {
            var button = $(event.relatedTarget)
            var id = button.data('writer_id')
